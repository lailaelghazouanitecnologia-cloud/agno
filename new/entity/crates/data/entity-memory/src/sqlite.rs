...
impl SqliteStorage {
    pub async fn new(path: &str) -> Result<Self> {
        let conn = Connection::open(path)
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to open SQLite: {}", e)))?;
    ...
    async fn init(&self) -> Result<()> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to initialize SQLite: {}", e)))?;
...
impl MemoryStorage for SqliteStorage {
    ...
    async fn save(&self, entry: MemoryEntry) -> Result<MemoryEntry> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to save: {}", e)))?;
    ...
    async fn get(&self, id: &str) -> Result<Option<MemoryEntry>> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to get: {}", e)))
    }
    ...
    async fn update(&self, mut entry: MemoryEntry) -> Result<MemoryEntry> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to update: {}", e)))?;
    ...
    async fn delete(&self, id: &str) -> Result<()> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to delete: {}", e)))?;
    ...
    async fn query(&self, query: MemoryQuery) -> Result<Vec<MemoryEntry>> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to query: {}", e)))
    }
    ...
    async fn delete_by_user(&self, user_id: &str) -> Result<usize> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to delete by user: {}", e)))
    }
    ...
    async fn delete_by_session(&self, session_id: &str) -> Result<usize> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to delete by session: {}", e)))
    }
    ...
    async fn get_topics(&self, user_id: &str) -> Result<Vec<String>> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to get topics: {}", e)))
    }
    ...
    async fn count(&self, query: MemoryQuery) -> Result<usize> {
        ...
        self.conn
            ...
            .await
            .map_err(|e| common_error::Error::new(common_error::ErrorKind::Io, format!("Failed to count: {}", e)))
    }
}
