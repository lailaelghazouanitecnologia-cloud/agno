...
mod tests {
    ...
    fn test_token_estimates() {
        ...
        let overview = file.token_estimate(crate::Depth::Overview);
        let structure = file.token_estimate(crate::Depth::Structure);
        let detail = file.token_estimate(crate::Depth::Detail);
